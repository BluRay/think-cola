...
public class FuturesService implements IFuturesService {
    ...
    @Override
    public int insertTradeBooksData(Map<String, Object> parmsMap) {
      List<Map<String, Object>> dateList = new ArrayList<Map<String, Object>>();
      dateList = futuresMapper.getRqTradeBooksData(parmsMap);
      if (dateList.size() > 0) {
        return -1;
      }
      futuresMapper.insertTradeBooksData(parmsMap);
      return 0;
    }
    @Override
    public int updateTradeBooksData(Map<String, Object> parmsMap) {
      futuresMapper.updateTradeBooksData(parmsMap);
      return 0;
    }
    @Override
    public int deleteTradeBooksData(Map<String, Object> parmsMap) {
      futuresMapper.deleteTradeBooksData(parmsMap);
      return 0;
    }
    ...
    @Override
    public int insertTradeAccountData(Map<String, Object> parmsMap) {
      List<Map<String, Object>> dateList = new ArrayList<Map<String, Object>>();
      dateList = futuresMapper.getRqTradeAccountData(parmsMap);
      if (dateList.size() > 0) {
        return -1;
      }
      futuresMapper.insertTradeAccountData(parmsMap);
      return 0;
    }
    @Override
    public int updateTradeAccountData(Map<String, Object> parmsMap) {
      futuresMapper.updateTradeAccountData(parmsMap);
      return 0;
    }
    @Override
    public int deleteTradeAccountData(Map<String, Object> parmsMap) {
